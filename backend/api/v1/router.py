...
from api.v1.endpoints import auth, sessions, messages, triage, reports, ai, doctor, prescriptions, visits, notifications, feedback, risk, reminders, places, patient
...
api_router.include_router(patient.router, prefix="/patient")
